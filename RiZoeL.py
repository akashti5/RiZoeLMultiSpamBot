...
@idk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@adk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@edk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@sid.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@shy.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@aan.on(events.NewMessage(incoming=True, pattern=r"^Ok")) 
@ake.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@eel.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@khu.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@shi.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
@dav.on(events.NewMessage(incoming=True, pattern=r"^Ok"))
